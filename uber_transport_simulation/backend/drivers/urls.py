...
# from .views import DriverSignupView,DriverProfileView, DriverLoginView,DriverUpdateProfileView,DriverRateView, DriverDeleteProfileView,DriverLocationUpdateView# Import DriverLoginView
