...
#         rides = Ride.objects.filter(customer__customer_id=customer_id)
...
#         rides = Ride.objects.filter(driver__driver_id=driver_id)
#         serializer = self.get_serializer(rides, many=True)
#         return Response(serializer.data)
...
#         # Serializer handles setting the customer and status
