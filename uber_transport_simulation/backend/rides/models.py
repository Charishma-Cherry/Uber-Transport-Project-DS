...
#    event_images = models.ManyToManyField('RideImage', blank=True, related_name='related_rides')  # Updated related_name
...
#     ride = models.ForeignKey(Ride, on_delete=models.CASCADE, related_name="event_images")
#     image = models.ImageField(upload_to="ride_images/")
#     uploaded_at = models.DateTimeField(auto_now_add=True)

#     def __str__(self):
#         return f"Image for Ride {self.ride.ride_id}"
...
class Ride(models.Model):
    ...
    passenger_count = models.IntegerField(default=1)
    status = models.CharField(max_length=10, choices=RIDE_STATUS_CHOICES, default='requested')
    event_images = models.ManyToManyField('RideImage', blank=True, related_name='ride_images')  # Updated related_name
...
class RideImage(models.Model):
    ride = models.ForeignKey(Ride, related_name='ride_images', on_delete=models.CASCADE)
    image = models.ImageField(upload_to="ride_images/")
    uploaded_at = models.DateTimeField(auto_now_add=True)
