...
# # Instantiate the RideViewSet to provide the view functions
...
# urlpatterns = [
#     # Ride list and create
#     path('rides/', ride_list, name='ride-list'),

#     path('rides/', ride_create, name='ride-create'),

    
#     # Ride details (retrieve, update, partial update, delete)
#     path('rides/<int:pk>/', ride_detail, name='ride-detail'),
    
#     # List all rides of a customer
#     path('rides/customer/<str:customer_id>/', list_customer_rides, name='customer-rides'),
    
#     # List all rides of a driver
#     path('rides/driver/<str:driver_id>/', list_driver_rides, name='driver-rides'),
    
#     # Ride statistics by location
#     path('rides/statistics/location/', ride_statistics, name='ride-statistics'),
