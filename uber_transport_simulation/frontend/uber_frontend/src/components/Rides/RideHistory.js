...
// //   const handleFileChange = (rideId, event) => {
...
// //   const uploadImages = async (rideId) => {
// //     const images = selectedImages[rideId];
// //     if (!images || images.length === 0) {
// //       alert('No images selected. Please select images to upload.');
// //       return;
// //     }
...
// //               <th style={styles.tableHeader}>Dropoff Location</th>
// //               <th style={styles.tableHeader}>Status</th>
// //               <th style={styles.tableHeader}>Upload Images</th>
// //             </tr>
// //           </thead>
// //           <tbody>
// //             {rideHistory.map((ride) => (
// //               <tr key={ride.ride_id} style={styles.tableRow}>
// //                 <td style={styles.tableCell}>{ride.driver_unique_id || 'N/A'}</td>
// //                 <td style={styles.tableCell}>{ride.ride_id}</td>
// //                 <td style={styles.tableCell}>{ride.pickup_location}</td>
// //                 <td style={styles.tableCell}>{ride.dropoff_location}</td>
...
// //                         type="file"
// //                         multiple
// //                         onChange={(e) => handleFileChange(ride.ride_id, e)}
// //                       />
// //                       <button
// //                         style={styles.button}
// //                         onClick={() => uploadImages(ride.ride_id)}
// //                       >
// //                         Upload
// //                       </button>
// //                       {uploadStatus[ride.ride_id] && (
// //                         <p>{uploadStatus[ride.ride_id]}</p>
// //                       )}
// //                     </>
// //                   ) : (
// //                     'N/A'
...
//   const handleViewBillClick = (rideId) => {
//     navigate(`/user/ride-bill/${rideId}`);
//   };
...
//                       <button
//                         style={styles.button}
//                         onClick={() => submitRating(ride.ride_id)}
//                       >
//                         Submit
//                       </button>
//                     </>
      ...
      {loading ? (
        ...
        <table style={styles.table}>
          <thead>
            <tr>
              <th style={styles.tableHeader}>Ride ID</th>
              <th style={styles.tableHeader}>Pickup</th>
              <th style={styles.tableHeader}>Dropoff</th>
              <th style={styles.tableHeader}>Status</th>
              <th style={styles.tableHeader}>Actions</th>
            </tr>
          </thead>
            ...
            {rideHistory.map((ride) => (
              <tr key={ride.ride_id} style={styles.tableRow}>
                ...
                <td style={styles.tableCell}>
                  ...
                  {ride.status === 'completed' && (
                    <>
                      {!ratedRides[ride.ride_id] ? (
                        <>
                          <select
                            value={ratings[ride.ride_id] || ''}
                            onChange={(e) =>
                              handleRatingChange(ride.ride_id, e.target.value)
                            }
                          >
                            <option value="">Rate</option>
